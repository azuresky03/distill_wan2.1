...
def distill_one_step(
    ...
    if debug_save_dir:
        ...
        if debug_save_dir:
            ...
            with torch.no_grad():
                for value,name in [(latents,"latents"),(model_pred,"model_pred")]:
...
def main(args):
    ...
    for step in range(init_steps + 1, args.max_train_steps + 1):
        ...
        if DEBUG:
            ...
            debug_save_dir = f"/vepfs-zulution/zhangpengpeng/cv/video_generation/Wan2.1/debug/exp6/{step}"
