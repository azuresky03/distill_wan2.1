        ...
        with torch.no_grad():
            with torch.autocast("cuda", dtype=torch.bfloat16):
                ...
                if ema_transformer is not None:
                    ...
                    target_pred = transformer(x_prev_list,timesteps_prev,None,max_seq_len,batch_context=encoder_hidden_states,context_mask=encoder_attention_mask,guidance=guidance_tensor)[0] #43200
