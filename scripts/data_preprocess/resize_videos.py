...
def process_folder(args):
    ...
    video_files = [f for f in input_path.rglob('*') if f.is_file() and f.suffix.lower() in video_extensions]
    ...
    process_args = [(video_file, output_path / video_file.relative_to(input_path).parent, args.width, args.height, args.fps) for video_file in video_files]
...
def parse_args():
    ...
    parser.add_argument('--width', type=int, default=832, help='Target width in pixels (default: 848)')
