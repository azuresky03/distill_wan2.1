...
MODEL_TYPE="hunyuan"
DATA_MERGE_PATH="/cv/zhangpengpeng/cv/video_generation/Wan2.1/data/mixkit/merge.txt"
OUTPUT_DIR="/cv/zhangpengpeng/cv/video_generation/Wan2.1/data/processed/mixkit/720"
